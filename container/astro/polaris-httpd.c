...
"<div style='color:var(--dim);font-size:12.5px'>The Polaris powers its Wi-Fi down "
"<b>60 s after the Benro app disconnects</b> &mdash; the network disappears, taking this "
"page, ssh, Alpaca and LX200 with it, and only a Bluetooth wake from the app or a power "
"cycle brings it back. It is firmware behaviour with no setting.<br><br>"
"<b>Holding a connection open does not prevent it.</b> The timer watches the app client "
"count, and a plain TCP connection &mdash; even one that sends valid protocol messages "
"&mdash; is never entered into that table: the device answers "
"<code>SP_ClientCtxDel: not find this is id[N]</code> when it closes. Verified twice, "
"from loopback and from the Wi-Fi address. A toggle that claimed to keep Wi-Fi awake was "
"removed rather than left here doing nothing.</div></div>"
